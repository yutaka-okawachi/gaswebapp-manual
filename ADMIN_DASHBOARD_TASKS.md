...
- [x] `period=7/30/90` だけを許可（180日は2026-07-28に廃止）
...
- [x] 0件検索語一覧をJSONへ含めない
- [x] `CacheService` で15分間キャッシュ
- [x] 同期間の同時集計をロックし、待機後にキャッシュを再確認
- [x] エラー時のJSON形式を固定
- [x] APIを公開集計値だけに限定
...
- [x] 30日応答を検証
- [x] 90日応答を検証
- [x] 180日指定が `INVALID_PERIOD` になることを検証
- [x] データがない日を0件として補完
- [x] 日本時間の日付境界を確認
...
- [x] 実例クリック率の分母を確認
- [x] 7・30・90日の切替を確認（180日は2026-07-28に廃止）
- [x] 棒グラフの表示を確認
- [x] PC幅とスマートフォン幅で確認
- [x] ローカルビルドとテストを実施
