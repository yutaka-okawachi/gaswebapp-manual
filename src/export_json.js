function exportAllDataToJson() {
    ...
    // 9. Generate dic.html (静的HTML生成 - リンク機能付き実験版を使用)
    ...
    // 10. Generate dic_terms_index.json (リンク用インデックス)
    Logger.log('=== 用語インデックスを生成中 ===');
    ...
    const files = {
        ...
        'mahler-search-app/dic.html': dicHtml,  // リンク機能付きHTML
