        ...
        <div class="container">
            ...
            <div class="info-notice">
                <div class="info-notice-content">
                    <p>💡 <strong>より詳細な検索：</strong>Richard Wagner（リヒャルト・ワーグナー），Gustav Mahler（グスタフ・マーラー），Richard Strauss（リヒャルト・シュトラウス）のスコアに記された指示を，作品名や楽器，ページ番号，指示対象などから直接検索可能．実際の使用箇所を確認したい場合はメイン検索へ．</p>
                </div>
