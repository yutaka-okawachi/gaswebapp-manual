...
const SECRET_TOKEN = "e58abb2e-1ab9-4cde-b1ee-5ec4dcaa9424";
...
function generateSecretToken() {
  ...
  Logger.log("Generated secret token:");
  Logger.log(token);
  Logger.log("\nCopy this token and:");
  Logger.log("1. Replace SECRET_TOKEN in web_trigger.js");
  Logger.log("2. Run 'clasp push' to update");
  Logger.log("3. Set as environment variable GAS_SECRET_TOKEN");
  return token;
}
